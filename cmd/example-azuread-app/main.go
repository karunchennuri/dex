...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.redirectURI, "redirect-uri", "http://localhost:5555/callback", "Callback URL for OAuth2 responses.")
	c.Flags().StringVar(&issuerURL, "issuer", "http://localhost:5556/dex", "URL of the OpenID Connect issuer.")
	c.Flags().StringVar(&listen, "listen", "http://localhost:5555", "HTTP(S) address to listen at.")
